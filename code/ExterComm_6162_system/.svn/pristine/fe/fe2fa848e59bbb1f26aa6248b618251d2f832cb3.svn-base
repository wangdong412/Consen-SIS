...
/* subReason - CS1131 */
#define ERR_NO_SRC_FILE         (51)  /* 源文件不存在 */
#define ERR_SRC_FILE            (52)  /* 源文件无效 */
#define ERR_WRITE_FILE          (53)  /* 写文件操作失败 */
...
#define ERR_FWPRG_TYPE          (84)  /* 固件更新：程序类型错误 */
#define ERR_EVENT_INDEX         (85)  /* 读CM事件服务：事件索引值错误 */
#define ERR_ADD_EVENT           (86)  /* 添加CM事件错误 */
#define ERR_FWUPCONT_PACKNUM    (87)  /* 固件更新继续服务：子包号出错 */
#define ERR_CM_RTSUP_START      (88)  /* CM RTS更新开始出错 */
#define ERR_CM_RTSUP_CONT       (89)  /* CM RTS更新继续出错 */
#define ERR_CM_RTSCRCUP_START   (90)  /* CM RTSCRC更新开始出错 */
#define ERR_CM_RTSCRCUP_CONT    (91)  /* CM RTSCRC更新继续出错 */
#define ERR_CM_RTSCRCUP_END     (92)  /* CM RTSCRC更新完成错误 */
