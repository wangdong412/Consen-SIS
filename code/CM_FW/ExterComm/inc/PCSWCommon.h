...
#define APP_MAX_REQ_PMID        (3)      /* PMID的最大值：3 */
...
#define ERR_PARA                (17)  /* 入参出错：函数调用出错，无需应答 */

/* subReason - CS1131 */
#define ERR_CM_SRCUP_START      (21)  /* CM源文件更新开始出错 */
#define ERR_CM_SRCUP_CONT       (22)  /* CM源文件更新继续出错 */
#define ERR_CM_SRCUP_FILE_LEN   (23)  /* CM源文件更新：文件数据长度错误 */
#define ERR_READ_FILE           (24)  /* 读文件操作失败 */
#define ERR_READ_STS_TYPE       (25)  /* 读取CM及PM状态服务：请求类型错误 */
#define ERR_TOTAL_CNT           (26)  /* 定义监视变量表服务： 变量个数超限 */
#define ERR_DEF_VARIABLE        (27)  /* 定义监视变量表服务：存在出错变量 */
#define ERR_ADD_PROJVER         (28)  /* 登录服务应答：添加工程版本信息出错 */
#define ERR_ADD_STATUS          (29)  /* 读取CM/PM状态服务：添加状态信息出错 */
#define ERR_ADD_ONLINE_DATA     (30)  /* 读变量在线值服务：添加变量在线值出错 */
#define ERR_SRCUP_INIT          (31)  /* 与源文件更新相关的资源初始化失败 */
#define ERR_ADD_IO_STATUS       (32)  /* 读取所有IO模块状态服务：添加IO状态信息出错 */
#define ERR_TIMING_DATA         (33)  /* 1131校时服务：校时数据无效 */

/* subReason - OPC */
#define ERR_OPC_VER             (41)  /* 登录服务中OPC配置信息版本错误 */
#define ERR_ADD_OPCONLINE_DATA  (42)  /* 读变量服务：添加OPC变量在线值出错 */

/* subReason - Client */
#define ERR_CLI_PMID            (51)  /* PMID错误 */
#define ERR_ADD_DIAG            (52)  /* 添加诊断信息错误 */
#define ERR_ADD_VERN            (53)  /* 添加版本信息错误 */
#define ERR_EVENT_MID           (54)  /* 读(CM)事件服务：模块ID错误 */
#define ERR_EVENT_INDEX         (55)  /* 读(CM)事件服务：事件索引值错误 */
#define ERR_ADD_EVENT           (56)  /* 添加CM事件错误 */
#define ERR_ADD_IP              (57)  /* 添加IP地址错误 */
#define ERR_ADD_PMFWUP_STATUS   (58)  /* 添加PM固件升级状态数据错误 */

#define ERR_FWUP_INIT           (59)  /* 与固件更新相关的资源初始化失败 */
#define ERR_FWPRG_TYPE          (60)  /* 固件更新：程序类型错误 */
#define ERR_FWUPCONT_PACKNUM    (61)  /* 固件更新继续服务：子包号出错 */
#define ERR_CM_RTSUP_START      (62)  /* CM RTS更新开始出错 */
#define ERR_CM_RTSUP_CONT       (63)  /* CM RTS更新继续出错 */
#define ERR_CM_RTSCRCUP_START   (64)  /* CM RTSCRC更新开始出错 */
#define ERR_CM_RTSCRCUP_CONT    (65)  /* CM RTSCRC更新继续出错 */
#define ERR_CM_RTSCRCUP_END     (66)  /* CM RTSCRC更新完成错误 */
#define ERR_CM_CHG_RTS_INDEX    (67)  /* 更新RTS索引值失败 */

#define ERR_CM_FPGAUP_START     (68)  /* CM FPGA更新开始出错 */
#define ERR_CM_FPGAUP_CONT      (69)  /* CM FPGA更新继续出错 */
#define ERR_CM_CHG_FPGA_INDEX   (70)  /* 更新FPGA索引值失败 */

#define ERR_CM_FWUP_OPR         (71)  /* CM固件更新：操作类型错误 */
#define ERR_CM_FWUP_FILE_LEN    (72) /* CM固件更新：文件数据长度错误 */

#define ERR_FWUP_BUSY           (73) /* CM固件更新：CM Busy，即升级包下发速度快，CM处理不过来 */
#define ERR_CM_FWUP_FILE_CRC    (74) /* CM固件更新：文件CRC错误 */
#define ERR_SEND_OPR_MSG        (75) /* CM固件更新：发送操作消息失败 */
#define ERR_SENDOPRMSG_NOT_FIN  (76) /* CM固件更新：操作消息未发送完成 */
