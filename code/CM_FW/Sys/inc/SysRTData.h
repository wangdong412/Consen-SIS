...
#define MAX_RTDATA_AREA_LEN             (216*1024)    /* 实时数据区大小 */
#define MAX_RTDATA_G_AREA_LEN           (200*1024u)   /* G区大小 */
...
#define MAX_SLAVE_NUM                   (32)     /* 模块的最大个数 */
...
#define MAX_BI_NUM                      (2U)     /* BI模块的最大个数 */
#define MAX_PW_NUM                      (2U)     /* PW模块的最大个数 */
