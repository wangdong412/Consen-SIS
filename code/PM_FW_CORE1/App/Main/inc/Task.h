...
#define CFG_TASK_START_TIME_OFFSET  (TASK_TIME_SLIDE_RTS*5)
#define DIAG_TASK_START_TIME_OFFSET  ((TASK_TIME_SLIDE_RTS + TASK_TIME_SLIDE_CFG)*5)
#define FILE_TASK_START_TIME_OFFSET  ((TASK_TIME_SLIDE_RTS + TASK_TIME_SLIDE_CFG + TASK_TIME_SLIDE_DIAG)*5)
#define COMM_TASK_START_TIME_OFFSET  ((TASK_TIME_SLIDE_RTS + TASK_TIME_SLIDE_CFG + TASK_TIME_SLIDE_DIAG + TASK_TIME_SLIDE_FILE)*5)
#endif
...
#ifdef INT_500US
#define TASK_TIME_SLIDE_RTS    (uint32_t)(4u)     /* 2.0ms */
#define TASK_TIME_SLIDE_CFG    (uint32_t)(1u)     /* 0.5ms */
