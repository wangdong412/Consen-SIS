...
#define CS1131_SLAVE_CONFIRM        (1041)      /* 用户对从站连接进行确认 */
...
/*DAIG service ID*/
#define READ_IOCFG_START            (2503)
#define READ_IOCFG_CONTINUE         (2504)

#define LOG_READ_RECORD             (2505)

#define DIAG_INFO_CLEAR             (2507)

#define FW_UPDATE_START             (2510)
#define FW_UPDATE_CONTINUE          (2511)
#define FW_UPDATE_DONE              (2512)
#define FW_UPDATE_GET_STAT          (2513)
...
#define ERR_WRITE_FILE_START        (107)    /*写文件开始失败*/
#define ERR_WRITE_FILE_CONTINUE     (108)    /*写文件继续失败*/
#define ERR_WRITE_FILE_END          (109)    /*写文件完成失败*/
#define ERR_READ_FILE_START         (110)    /*读文件开始失败*/
#define ERR_READ_FILE_CONTINUE      (111)    /*读文件继续失败*/
#define ERR_WRITE_VAR               (112)    /*写变量错误（变量个数）*/
#define ERR_FORCE_LIST              (113)    /*强制列表错误（变量个数）*/
#define ERR_DISABLE_TABL_LEN        (114)    /*强制列表长度错误*/
#define ERR_DISABLE_TABL_CRC        (115)    /*强制列表CRC错误*/
#define ERR_TASK_ID                 (116)    /*调试命令下发任务ID错误*/
#define ERR_WRITE_VAR_ITERM         (117)    /*写变量错误（单个变量信息条目）*/
#define ERR_DISABLE_ITERM           (118)    /*强制列表错误（单个变量信息条目）*/
...
#define ERR_APPEND_NULL             (123)
#define ERR_SLAVE_CONFIRM           (124)
#define ERR_NOT_PROGRAM             (125)    /*钥匙开关不在PROG*/

#define ERR_OPC_WRITE_VAR           (126)   /*OPC写变量错误*/
#define ERR_OPC_READ_CLOCK          (127)

#define ERR_CTRL_PAUSE              (128)
#define ERR_CTRL_CONTINUE           (129)

#define ERR_SOE_READ                (130)   /*读SOE处理失败*/
#define ERR_SOE_CLEAR               (131)   /*清空SOE失败*/

#define ERR_LOG_READ                (132)   /*读日志处理失败*/

#define ERR_FW_WRITE_START          (133)
#define ERR_FW_WRITE_CONTINUE       (134)
#define ERR_FW_WRITE_END            (135)

#define ERR_DIAG_CLEAR_MODID        (136)
#define ERR_DIAG_CLEAR              (137)

#define ERR_AMS_TIMEOUT             (138)
#define ERR_AMS_MODADDR_ERR         (139)
#define ERR_AMS_CHANNEL_ERR         (140)
#define ERR_AMS_APPEND_ERR          (141)
#define ERR_NOT_PRJ                 (142)    /*没有工程*/
...
#define FS_OPERATE_TIMEOUT           (1000)    /* file operate timeout */
...
#define MAX_READ_FILE_LEN           (2*1024)
#define MAX_WRITE_FILE_LEN          (2*1024)
...
typedef struct DiagInfoClearSrvTag
{
    uint8_t ucPMID;                                     /*PMID*/
    uint8_t ucClearType;
    uint16_t usModID;                                    /*I/O模块的编号*/
}DiagInfoClearSrv_t;
