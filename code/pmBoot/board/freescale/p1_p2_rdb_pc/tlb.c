...
#else
	/* *I*G* - PCI memory flash 128M */
	SET_TLB_ENTRY(1, CONFIG_SYS_PCIE1_MEM_VIRT, CONFIG_SYS_PCIE1_MEM_PHYS,
			MAS3_SX|MAS3_SW|MAS3_SR, MAS2_I|MAS2_G,
			0, 3, BOOKE_PAGESZ_128M, 1),

	/* *I*G* - PCI I/O effective: ?k*/
	SET_TLB_ENTRY(1, CONFIG_SYS_PCIE1_IO_VIRT, CONFIG_SYS_PCIE1_IO_PHYS,
			MAS3_SX|MAS3_SW|MAS3_SR, MAS2_I|MAS2_G,
			0, 4, BOOKE_PAGESZ_256K, 1),

	/* *I*G* - PCI memory IO 128M */
	SET_TLB_ENTRY(1, CONFIG_SYS_PCIE2_MEM_VIRT, CONFIG_SYS_PCIE2_MEM_PHYS,
			MAS3_SX|MAS3_SW|MAS3_SR, MAS2_I|MAS2_G,
			0, 8, BOOKE_PAGESZ_128M, 1),
...
#if !defined(FSL_CONFIG_SOC) 
        /*ezio 4.12*/
    SET_TLB_ENTRY(1, CAG_SYS_SRAM_BASE1, CAG_SYS_SRAM_BASE1,
                  MAS3_SX|MAS3_SW|MAS3_SR,MAS2_I|MAS2_G,
                  0, 6, BOOKE_PAGESZ_1M, 1),
    SET_TLB_ENTRY(1, CAG_SYS_FPGA_BASE1, CAG_SYS_FPGA_BASE1,
                  MAS3_SX|MAS3_SW|MAS3_SR,MAS2_I|MAS2_G,
