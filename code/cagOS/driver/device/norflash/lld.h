...
#define LLD_VERSION   "13.1.1"   /*  Year.Quarter.Minor*/
...
typedef unsigned int LLD_UINT32;  /* 32 bits wide */
...
typedef LLD_UINT32      ulong;
typedef LLD_CHAR        uchar;      /* 8 bit wids */
...
/* for GL-R */
#define WSXXX_LOCK_REG2_ENTRY     (0x41*LLD_DEV_MULTIPLIER)  
...
#ifdef  LLD_CONFIGURATION_X16_AS_X16
/*go in this branch*/
...
/*api for fs*/
#define LLD_PORT_WIDTH 2    /*portwidth should always be even*/
/*16*16*/
