...
CPU_STK        OSCfg_IdleTaskStk   [1000/*TASK_STACK_SIZE*/];
...
CPU_STK      * const  OSCfg_IdleTaskStkBasePtr   = (CPU_STK    *)TASK_STACK_4;
#else
CPU_STK      * const  OSCfg_IdleTaskStkBasePtr   = (CPU_STK    *)TASK_STACK_5;
#endif
CPU_STK_SIZE   const  OSCfg_IdleTaskStkLimit     = (CPU_STK_SIZE)OS_CFG_IDLE_TASK_STK_LIMIT;

CPU_STK_SIZE   const  OSCfg_IdleTaskStkSize      = (CPU_STK_SIZE)STASK_SIZE;
