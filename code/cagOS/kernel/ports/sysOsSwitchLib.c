...
extern UINT32 CpuCore;
unsigned long rtsdebug = 0x0;

#define STACK_BUFFER_SIZE   0xA0
unsigned long rtsRunning = 0;
...
void  OSInitHook (void)
{
    OSTickCtr=0;
    OSTickTaskTimeMax=0;
    OSTickListDly.TCB_Ptr = (void*)0;
    OSTickListTimeout.TCB_Ptr=(void*)0;
}
                         ...
                         OS_OPT         opt)
{
    ...
    /* 8-byte align task's stack pointer (EABI) *//*16byte align?*/
