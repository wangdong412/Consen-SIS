...
static Pause_Flag_t s_emSysPauseFlag = PF_CONTINUE;
...
{
    s_stSysAjustSyncTime[emPMId].emAjustEn = emAjustEn;
...
{
    Key_Switch_Type_t emKeySwitchType;

    return emKeySwitchType;
}
...
{
    if((SYS_CONTINUE == emSysPauseFlag ) || (SYS_PAUSE == emSysPauseFlag ))
    {
        s_emSysPauseFlag = emSysPauseFlag;
    }
