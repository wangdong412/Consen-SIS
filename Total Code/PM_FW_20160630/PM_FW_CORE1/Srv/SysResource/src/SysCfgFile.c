...
***********************************************************************************************************************
*/
static SysCfgDB_t* FindReadableDB(void);
static SysCfgDB_t* FindWriteableDB(void);
...
static SysCfgDB_t* FindReadableDB(void)
{
    ...
    if(CFG_DB_RD_ENABLE == s_stSysCfgDB[CFG_DB_A].bReadable) //&& (CFG_DB_FULL == s_stSysCfgDB[CFG_DB_A].bDBStatus)
    {
        pstCfg = &(s_stSysCfgDB[CFG_DB_A]);
    }
    else if(CFG_DB_RD_ENABLE == s_stSysCfgDB[CFG_DB_B].bReadable)
    {
...
static SysCfgDB_t* FindWriteableDB(void)
{
    ...
    if( CFG_DB_WR_ENABLE == s_stSysCfgDB[CFG_DB_A].bWriteable ) //&& (CFG_DB_EMPTY == s_stSysCfgDB[CFG_DB_A].bDBStatus)
    {
        pstCfg = &(s_stSysCfgDB[CFG_DB_A]);
    }
    else if( CFG_DB_WR_ENABLE == s_stSysCfgDB[CFG_DB_B].bWriteable )
