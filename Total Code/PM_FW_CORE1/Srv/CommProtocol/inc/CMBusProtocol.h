...
#define MAX_RTDATA_PACKAGE_SIZE             (512)            /* 每次传输实时数据包的最大长度 */
#else
#define MAX_RTDATA_PACKAGE_SIZE             (2048)            /* 每次传输实时数据包的最大长度 */
#endif
...
#define COMM_PRO_CS1131_REQ   (LOG1_ID_SRV_COMM_PROTOCOL_LEVEL0 + 1)
#define COMM_PRO_CS1131_RESP   (LOG1_ID_SRV_COMM_PROTOCOL_LEVEL0 + 2)
/*
***********************************************************************************************************************
*                                数据结构定义
***********************************************************************************************************************
