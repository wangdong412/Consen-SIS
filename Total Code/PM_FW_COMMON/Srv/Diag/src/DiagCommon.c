...
static uint32_t s_uiCore0TestFail = 0xFFFFFFFFU;
static uint32_t s_uiCore1TestFail = 0xFFFFFFFFU;
/*
***********************************************************************************************************************
...
{
    printf("CPUDiagVec=0x%x, CodeDiagVec=0x%x, RamDiagVec=0x%x, ExceptionDiagVec=0x%x", \
            pstDiagCtrlInfo->uiCPUDiagVec, pstDiagCtrlInfo->uiCodeDiagVec, \
            pstDiagCtrlInfo->uiRamDiagVec, pstDiagCtrlInfo->uiExceptionDiagVec);

    LogWrite(LOG1_ID_USER_L0_SELF_TEST|(pstDiagCtrlInfo->uiCPUDiagVec & 0x0FFF));
    LogWrite(LOG1_ID_USER_L0_SELF_TEST|(pstDiagCtrlInfo->uiCodeDiagVec & 0x0FFF));
    LogWrite(LOG1_ID_USER_L0_SELF_TEST|(pstDiagCtrlInfo->uiRamDiagVec & 0x0FFF));
    LogWrite(LOG1_ID_USER_L0_SELF_TEST|(pstDiagCtrlInfo->uiExceptionDiagVec & 0x0FFF));
