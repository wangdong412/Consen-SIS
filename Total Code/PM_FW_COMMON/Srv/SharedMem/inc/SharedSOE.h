...
/* 对SRAM的地址规划 */
#define SOE_SRAM_SEC0_START_ADDR                  (0xFF600000+16)
#define SOE_SRAM_SEC1_START_ADDR                  (0xFF610000+16)

#define SOE_SRAM_QUEUE_INFO_START_ADDR            (0xFF620000-512)

#define SOE_SRAM_SEC2_START_ADDR                  (0xFF620000+16)
#define SOE_SRAM_SEC3_START_ADDR                  (0xFF630000+16)

#define SOE_RECORD_SEC0_START_INDEX               (0U)
#define SOE_RECORD_SEC0_MAX_INDEX                 (5400U)
#define SOE_RECORD_SEC1_START_INDEX               (5401U)
#define SOE_RECORD_SEC1_MAX_INDEX                 (9999U)

#define SOE_RECORD_SEC2_START_INDEX               (0U)
#define SOE_RECORD_SEC2_MAX_INDEX                 (5400U)
#define SOE_RECORD_SEC3_START_INDEX               (5401U)
