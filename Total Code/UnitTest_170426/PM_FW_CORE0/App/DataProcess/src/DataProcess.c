...
//    if(0 == x % 2)
//    {
//        sysGpioLineSet (GPIO_2, GPIO_HIGH);
//    }
//    else
//    {
//        sysGpioLineSet (GPIO_2, GPIO_LOW);
//    }
//    x++;
//    return;
//}
...
void DataProcessOutputHandle(void)
{
    ...
    if((DataProcessCheckDownloadIOConfigFinish() == IPBUS_DEVICE_CONFIG_SLAVE) && (pstUP1IoModInfo != NULL) && 
       (pstUP2IoModInfo != NULL) && (pstAppend != NULL) && (pstCtrlStationInfo != NULL))
    {
...
//                                    printf("Online1 %x %x\n",
//                                            ucSlaveNo,pstAppend->stSlaveState[ucSlaveNo].stSlaveDiag.ucOnlineDiag);
                                }
                            }
                        }
...
void DataProcessSlaveConfirmInit(void)
{
    ...
    if(pstAppend != NULL)
    {
        for(uiSlaveCount = 0; uiSlaveCount < MAX_MOD_NUM; uiSlaveCount++)
        {
