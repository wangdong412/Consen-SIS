...
void SharedRtDataInit(void)
{
    ...
    memset((puint8_t)&g_stSharedRtData.stAppend.ucModBusCtrl[0], 0x00, sizeof(uint8_t)* MAX_MODBUS_CTRL_INFO);
    memset((puint8_t)&g_stSharedRtData.stAppend.ucP2PCtrl[0], 0x00, sizeof(uint8_t)* MAX_P2P_CTRL_INFO);
