...
//    uint8_t ucTest = 0U;
//    if(15 == pstSysIoModInfo->stSysIoParamArea.stIoParamIndex[7].ucModAddr)
//    {
//        printf("PRA:");
//        for(ucTest = 20; ucTest < 30; ucTest++)
//        {
//            printf("%x",pstSysIoModInfo->stSysIoParamArea.ucIoParam[pstSysIoModInfo->stSysIoParamArea.stIoParamIndex[7].usParamAreaOffset + ucTest]);
//        }
//        printf("\n");
//    }
