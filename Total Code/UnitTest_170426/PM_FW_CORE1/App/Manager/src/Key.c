...
//    printf("  KeyManagerCycle  \n");
    ...
    switch(uiKeyPos)
    {
        case KS_INIT:
        {
            ...
            {
                SharedSetSwitchPosTmp(uiKeyPos);
            }
        }
        break;
    ...
    pstAppend->stPMState.stPMFirmwareState.usKeyPosition = (uint16_t)emKeySwitchVote;

    /* 更新状态灯的状态 */
    switch(emKeySwitchVote)
    {
        case KS_INIT:
        {
            ...
            if(false == bInitWrLogFlag)
            {
                ...
                LogWrite(LOG1_ID_USER_L0_KEY_INIT);
                bInitWrLogFlag = true;
        ...
        case KS_PROGRAM:
        {
            ...
            if(false == bProgWrLogFlag)
            {
                ...
                LogWrite(LOG1_ID_USER_L0_KEY_PROG);
        ...
        case KS_RUN:
        {
            ...
            if(false == bStartWrLogFlag)
            {
                ...
                LogWrite(LOG1_ID_USER_L0_KEY_STRT);
                bInitWrLogFlag = false;
        ...
        case KS_STOP:
        {
            ...
            if(false == bStopWrLogFlag)
            {
                ...
                LogWrite(LOG1_ID_USER_L0_KEY_STOP);
                bInitWrLogFlag = false;
                bStartWrLogFlag = false;
                bStopWrLogFlag = true;
                bProgWrLogFlag = false;
