...
//    SysSetSWRuninOK(SW_RUNING_OK_VAR);
    ...
    if((pstLocalPMState != NULL) && (pstNextPMState != NULL) && (pstPrePMState != NULL))
    {
        ...
        if(((emKeySwitch[PMA] & 0x06) == 0) && ((emKeySwitch[PMB] & 0x06) == 0) && ((emKeySwitch[PMC] & 0x06) == 0))
        {
            if((emKeySwitch[PMA] == emKeySwitch[PMB]))
            {
                emKeySwitchVote = emKeySwitch[PMA];
            }
            else if((emKeySwitch[PMB] == emKeySwitch[PMC]))
            {
                emKeySwitchVote = emKeySwitch[PMB];
            }
            else if((emKeySwitch[PMA] == emKeySwitch[PMC]))
            {
                emKeySwitchVote = emKeySwitch[PMA];
            }
            else
        ...
        else if(((emKeySwitch[PMA] & 0x06) == 0) && ((emKeySwitch[PMB] & 0x06) == 0))
        {
            if((emKeySwitch[PMA] == emKeySwitch[PMB]))
            {
                emKeySwitchVote = emKeySwitch[PMA];
        ...
        else if(((emKeySwitch[PMA] & 0x06) == 0) && ((emKeySwitch[PMC] & 0x06) == 0))
        {
            if((emKeySwitch[PMA] == emKeySwitch[PMC]))
            {
                emKeySwitchVote = emKeySwitch[PMA];
            }
            else
        ...
        else if(((emKeySwitch[PMB] & 0x06) == 0) && ((emKeySwitch[PMC] & 0x06) == 0))
        {
            if((emKeySwitch[PMB] == emKeySwitch[PMC]))
            {
                emKeySwitchVote = emKeySwitch[PMB];
            }
            else
        ...
        else if((emKeySwitch[PMA] & 0x06) == 0)
        {
            emKeySwitchVote = emKeySwitch[PMA];
        }
        else if((emKeySwitch[PMB] & 0x06) == 0)
        {
            emKeySwitchVote = emKeySwitch[PMB];
        }
        else if((emKeySwitch[PMC] & 0x06) == 0)
        {
            emKeySwitchVote = emKeySwitch[PMC];
        }
        else
        {
            emKeySwitchVote = emKeySwitch[emLocalPMId];
