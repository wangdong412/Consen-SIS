...
#define ERR_WRITE_VAR               (58)
#define ERR_FORCE_LIST              (59)
#define ERR_DISABLE_TABL_LEN        (60)
#define ERR_DISABLE_TABL_CRC        (61)
#define ERR_TASK_ID                 (62)
#define ERR_WRITE_VAR_ITERM         (63)
#define ERR_DISABLE_ITERM           (64)
