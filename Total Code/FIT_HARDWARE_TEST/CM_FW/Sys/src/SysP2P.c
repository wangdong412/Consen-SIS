...
***********************************************************************************************************************
*/
bool_t SysClearP2PMsg (PMController_t emPMID, SysP2PMsgType_t emMsgType)
{
    SysP2PMsgBox_t *pstMsgBox = NULL;
    bool_t bRet = false;
...
/*
***********************************************************************************************************************
* 函数名称: SysClearStationMsg
*
* 功能描述: 清除其它控制站的请求/应答消息
*
* 输入参数: emMsgType: 各种消息类型
*
* 输出参数: 无
...
***********************************************************************************************************************
*/
bool_t SysClearStationMsg(SysP2PMsgType_t emMsgType)
{
    bool_t bRet = false;                    /* 函数返回值 */
    SysP2PMsgQueue_t *pstMsgQueue = NULL;
    ...
    if((emMsgType < NUM_OF_P2PMSGTYPE) && (emMsgType >= P2P_EXT_REQ))
    {
        ...
        /* 获取队列中消息个数及队头位置 */
        pstMsgQueue->usNum = 0;
        pstMsgQueue->usHead = 0;
        pstMsgQueue->usTail = 0;
        bRet = true;
    }
