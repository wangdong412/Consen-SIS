...
#define MODBUS_RNG_MIN            (0)         /* Modbus Range Min */
#define MODBUS_RNG_MAX            (32767)     /* Modbus Range Max */
#define MODBUS_MLP_MIN            (1)         /* Modbus Master Logic Port Min */
#define MODBUS_MLP_MAX            (32)        /* Modbus Master Logic Port Max */
