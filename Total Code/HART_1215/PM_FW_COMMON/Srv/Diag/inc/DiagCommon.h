...
#define DIAG_FIR_LSU_ADDR                   (0x00FF8000U)   /* 地址空间A片内LSU测试地址         */
#define DIAG_SEC_LSU_ADDR                   (0x013F8000U)   /* 地址空间B片内LSU测试地址         */
#define DIAG_THI_LSU_ADDR                   (0x017F8000U)   /* 地址空间C片内LSU测试地址         */
#define START_ADD_AREA_DATA_TEST_CPU_A_0    (0x00FF8000U)   /* 地址空间A片内data cache测试地址  */
#define START_ADD_AREA_DATA_TEST_CPU_B_0    (0x00FFC000U)   /* 地址空间A片内data cache测试地址  */

#define START_ADD_AREA_DATA_TEST_CPU_A_1    (0x013F8000U)   /* 地址空间B片内data cache测试地址  */
#define START_ADD_AREA_DATA_TEST_CPU_B_1    (0x013FC000U)   /* 地址空间B片内data cache测试地址  */

#define START_ADD_AREA_DATA_TEST_CPU_A_2    (0x017F8000U)   /* 地址空间C片内data cache测试地址  */
#define START_ADD_AREA_DATA_TEST_CPU_B_2    (0x017FC000U)   /* 地址空间C片内data cache测试地址  */
