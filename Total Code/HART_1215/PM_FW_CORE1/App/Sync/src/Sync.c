    ...
    {/* 校验接收缓存指针不为空 */
        ...
        {/* 接收长度大于等于零，接收到数据 */
            ...
            else
            {
                ...
                {
                    DEBUG_SYNC("RECV N: LastNum: %d Num: %d  Len: %d\n",\
        ...
        {/* 接收长度大于等于零，接收到数据 */
            ...
            else
            {
                ...
                {
                    DEBUG_SYNC("RECV P: lastNum: %d Num: %d Len: %d \n",\
...
void SyncRecvData(SyncRealData_t* pstSyncPrjData, PMController_t emSrcPMId)
{
    ...
    do
    {
        ...
        printf("AreaId: %d Off: %d Len: %d\n",pstSyncPrjData->stDataHead.emAreaId,\
                pstSyncPrjData->stDataHead.uiOffset, pstSyncPrjData->stDataHead.uiDataLen);
...
void SyncRecvRealDataOk(SyncRealData_t* pstSyncPrjData,PMController_t emSrcPMId)
{
    ...
    if(pstSyncPrjData->stDataHead.uiDataLen != uiAppendDataLen)
    {
        /*log*/
...
void SyncSendDataOk(PMController_t emDstPMId)
{
    ...
    pstSyncSendData->stDataHead.uiDataLen = uiAppendDataLen;
    ...
    /* 计算发送数据长度 */
    iSendLen = sizeof(SyncHead_t) + sizeof(SyncDataHead_t) + uiAppendDataLen;
