...
//                    DEBUG_CONFIG("  uiSOEVarNum is : %d \n",stSOEBlockInfo.uiSOEVarNum);
                    ...
                    printf("BlockID %d",ucBlockID);
                    printf("UpdateFlag %d",pstSOEConfigInfo->stSoftSOEBlock[ucBlockID].usUpdateFlag);
                    printf("BlockType %d",pstSOEConfigInfo->stSoftSOEBlock[ucBlockID].usBlockType);
                    printf("Property %d\n",pstSOEConfigInfo->stSoftSOEBlock[ucBlockID].ucProperty);
