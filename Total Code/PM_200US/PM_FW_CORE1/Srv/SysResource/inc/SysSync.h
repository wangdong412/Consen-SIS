...
/* 服务激活时间 */
#define SYNC_RELATIVE_ACTIVE_TIME       (1000U)
/* 服务超时时间 */
#define SYNC_RELATIVE_TIMEOUT_TIME      (600U)
/* 动态处理时间 */
...
/* 服务不需要处理 */
#define SRV_NOT_NEED_PROCESS            (0U)
/* 服务需要处理 */
#define SRV_NEED_PROCESS                (1U)
...
typedef enum
{
    ...
    SYS_BROADCAST_DIAGSRV,                              /* 同步任务:广播Diag服务数据 */
...
typedef struct SysAjustSyncTimeTag
{
    ...
    /* 系统时间*/
    ulong64_t ullSystemTime;
}SysAjustSyncTime_t; /* 24 bytes */
