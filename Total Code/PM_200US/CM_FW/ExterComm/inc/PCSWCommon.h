...
#define ERR_ADD_IO_STATUS       (62)  /* 读取所有IO模块状态服务：添加IO状态信息出错 */
...
#define ERR_ADD_IP              (87)  /* 添加IP地址错误 */
#define ERR_ADD_PMFWUP_STATUS   (88)  /* 添加PM固件升级状态数据错误 */

#define ERR_FWUP_INIT           (95)  /* 与固件更新相关的资源初始化失败 */
#define ERR_FWPRG_TYPE          (96)  /* 固件更新：程序类型错误 */
#define ERR_FWUPCONT_PACKNUM    (97)  /* 固件更新继续服务：子包号出错 */
#define ERR_CM_RTSUP_START      (98)  /* CM RTS更新开始出错 */
#define ERR_CM_RTSUP_CONT       (99)  /* CM RTS更新继续出错 */
#define ERR_CM_RTSCRCUP_START   (100)  /* CM RTSCRC更新开始出错 */
#define ERR_CM_RTSCRCUP_CONT    (101)  /* CM RTSCRC更新继续出错 */
#define ERR_CM_RTSCRCUP_END     (102)  /* CM RTSCRC更新完成错误 */
#define ERR_CM_CHG_RTS_INDEX    (103)  /* 更新RTS索引值失败 */

#define ERR_CM_FPGAUP_START     (104)  /* CM FPGA更新开始出错 */
#define ERR_CM_FPGAUP_CONT      (105)  /* CM FPGA更新继续出错 */
#define ERR_CM_CHG_FPGA_INDEX   (106)  /* 更新FPGA索引值失败 */

#define ERR_CM_FWUP_OPR         (107)  /* CM固件更新：操作类型错误 */
#define ERR_CM_FWUP_FILE_LEN    (108) /* CM固件更新：文件数据长度错误 */

#define ERR_FWUP_BUSY           (109) /* CM固件更新：CM Busy，即升级包下发速度快，CM处理不过来 */
#define ERR_CM_FWUP_FILE_CRC    (110) /* CM固件更新：文件CRC错误 */
#define ERR_SEND_OPR_MSG        (111) /* CM固件更新：发送操作消息失败 */
#define ERR_SENDOPRMSG_NOT_FIN  (112) /* CM固件更新：操作消息未发送完成 */
