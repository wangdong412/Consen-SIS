...
***********************************************************************************************************************
*/
#define MAX_CFG_CM_LEN              100000UL            /* CM模块配置文件缓冲区长度*/
#define MAX_CFG_MODBUS_SLAVE_LEN    100000UL            /* Modbus slave配置文件缓冲区长度*/
#define MAX_CFG_MODBUS_MASTER_LEN   100000UL            /* Modbus master配置文件缓冲区长度*/
#define MAX_CFG_OPC_LEN             100000UL            /* OPC配置文件缓冲区长度*/
#define MAX_CFG_CTRL_STAION_LEN     100000UL            /* 控制站配置文件缓冲区长度*/
#define MAX_CFG_SOE_LEN             100000UL            /* SOE配置文件缓冲区长度*/
#define MAX_CFG_P2P_LEN             100000UL            /* P2P配置文件缓冲区长度*/
#define MAX_CFG_VOTE_LEN            100000UL            /* 表决配置文件缓冲区长度*/
#define MAX_CFG_IO_MODULAR_LEN      100000UL            /* IO模块配置文件缓冲区长度*/
#define MAX_CFG_RETAIN_LEN          100000UL            /* 掉电保持配置文件缓冲区长度*/
...
#define CM_CFG_MAX_FILE_INDEX              (10)                /* CM最大配置文件索引号 */
/* 传输配置文件的标志 */
#define TRANS_ALL_CFG_FILE_START            (0x10000000)
#define TRANS_INC_CFG_FILE_START            (0x20000000)
#define TRANS_CFG_FILE_FINISH               (0x40000000)
...
typedef struct SysCfgFileStateTag
{
    ...
    uint32_t uiFileConfigFlg;                           /* 配置文件是否被配置*/
