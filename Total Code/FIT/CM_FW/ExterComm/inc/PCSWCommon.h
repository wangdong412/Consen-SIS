...
#define ERR_FWUP_INIT           (88)  /* 与固件更新相关的资源初始化失败 */
#define ERR_FWPRG_TYPE          (89)  /* 固件更新：程序类型错误 */
#define ERR_FWUPCONT_PACKNUM    (90)  /* 固件更新继续服务：子包号出错 */
#define ERR_CM_RTSUP_START      (91)  /* CM RTS更新开始出错 */
#define ERR_CM_RTSUP_CONT       (92)  /* CM RTS更新继续出错 */
#define ERR_CM_RTSCRCUP_START   (93)  /* CM RTSCRC更新开始出错 */
#define ERR_CM_RTSCRCUP_CONT    (94)  /* CM RTSCRC更新继续出错 */
#define ERR_CM_RTSCRCUP_END     (95)  /* CM RTSCRC更新完成错误 */
#define ERR_CM_CHG_RTS_INDEX    (96)  /* 更新RTS索引值失败 */

#define ERR_CM_FPGAUP_START     (97)  /* CM FPGA更新开始出错 */
#define ERR_CM_FPGAUP_CONT      (98)  /* CM FPGA更新继续出错 */
#define ERR_CM_CHG_FPGA_INDEX   (99)  /* 更新FPGA索引值失败 */

#define ERR_CM_FWUP_OPR         (100)  /* CM固件更新：操作类型错误 */
#define ERR_CM_FWUP_FILE_LEN    (101) /* CM固件更新：文件数据长度错误 */

#define ERR_FWUP_BUSY           (102) /* CM固件更新：CM Busy，即升级包下发速度快，CM处理不过来 */
#define ERR_CM_FWUP_FILE_CRC    (103) /* CM固件更新：文件CRC错误 */
#define ERR_SEND_OPR_MSG        (104) /* CM固件更新：发送操作消息失败 */
#define ERR_SENDOPRMSG_NOT_FIN  (105) /* CM固件更新：操作消息未发送完成 */
