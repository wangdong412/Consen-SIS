...
#define SOE_PM_TIMEOUT_CYCLE_CNT  (2*1000*1000/(MAIN_TASK_PERIOD))   /* PM应答SOE命令的超时拍数：2s */
#define SOE_SW_TIMEOUT_CYCLE_CNT  (30*1000*1000/(MAIN_TASK_PERIOD))  /* SOE软件超时拍数: 30s */
