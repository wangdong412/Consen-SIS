...
#ifeq (BIN0, $(BUILDBIN))
TEXT_BASE =0x04E90000
#endif
else
TEXT_BASE =0x00E90000 
endif
...
CFLAGS =  -O0 -ffunction-sections -fdata-sections -meabi -D__KERNEL__  -fno-builtin-printf -fno-builtin-printx -fno-builtin-puts  -nostdinc \
...
ASFLAGS =  -O0 -D__ASSEMBLY__ -ffunction-sections -fdata-sections -meabi -D__KERNEL__ -fno-builtin-printx -fno-builtin-printf -fno-builtin-puts  -nostdinc \
          -isystem $(gccincdir) -pipe -DCONFIG_PPC -D__powerpc__ -ffixed-r2 -Wa,-me500 \
          -Wstrict-prototypes -fno-stack-protector  -Wno-format-nonliteral  -Wno-format-security \
          -mhard-float -mstrict-align -fno-zero-initialized-in-bss -fstrength-reduce -D_CAG_START_TEXT=$(TEXT_BASE)
...
ifeq (BIN0, $(BUILDBIN))
LDFLAGS= -Bstatic -EB -defsym _CAG_DATA_ALIGN=1 -T RTSCORE0.lds --gc-section -Ttext=$(TEXT_BASE) -X -N 
endif
#ifeq (BIN1, $(BUILDBIN))
