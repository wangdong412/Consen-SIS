...
/* 每周期轮询IO个数 */
#define DATAPROCESS_SLAVE_POLL_NUM_TASK1  (3U)
#define DATAPROCESS_SLAVE_POLL_NUM_TASK2  (2U)
#define DATAPROCESS_SLAVE_POLL_NUM_TOTAL  (DATAPROCESS_SLAVE_POLL_NUM_TASK1 + DATAPROCESS_SLAVE_POLL_NUM_TASK2)
...
#define DATAPROCESS_AO_QDATA_LEN         (2U)
#define DATAPROCESS_DO_QDATA_LEN         (4U)
...
/* OSP监控数据类型 */
#define DATAPROCESS_OSP_OSPFUNCTION     (1U)
#define DATAPROCESS_OSP_DIRFUNCTION     (2U)
#define DATAPROCESS_OSP_NOFUNCTION      (3U)
...
#define SLAVE_COMFIRM_MASK          0x02
...
/* 从站通道OSPMonitor数据pack结构 */
typedef struct DataProcessOSPMonitorPackDataTag
{
    uint8_t ucDigPackA;
    uint8_t ucDigPackB;
    uint8_t ucDigPackC;
}DataProcessOSPMonitorPackData_t;

/* 从站通道OSPMonitor数据结构 */
typedef struct DataProcessOSPMonitorDataTag
{
    float_t fPRPMA;
    float_t fPRPMB;
    float_t fPRPMC;
    ...
    DataProcessOSPMonitorPackData_t OSPMonitorPackData;
}DataProcessOSPMonitorData_t;
