...
* ERRNO: N/A
*/
void bswap1(char * buf1, char* buf2, size_t nbytes)
{
	bswap(buf1, buf2, nbytes);
}
void bswap
    (
...
void swab1(unsigned short * source, unsigned short* desti, size_t nbytes)
{
	swab(source, desti, nbytes);
}
/*******************************************************************************
*
...
void uswabn(char * source, char* desti, size_t nbytes)
{
uswab(source, desti, nbytes);
}
/*******************************************************************************
*
...
* ERRNO: N/A
*/
void bzero1(char *buffer, size_t n)
{
	bzero(buffer, n);
}
void bzero
...
*/
void bcopy1(char * source, char* desti, size_t nbytes)
{
	bcopy(source, desti, nbytes);
}
void bcopy
    (
	const void *  source,        /* pointer to source buffer      */
...
*/
	int a[100];
	void bcopyBytes1(char * source, char* desti, size_t nbytes)
	{
		bcopyBytes(source, desti, nbytes);
	}
void bcopyBytes
    (
	const void *  source,        /* pointer to source buffer      */
...
* SEE ALSO: bcopy()
*/
void bcopyWords1(short * source, short* desti, size_t nbytes)
{
	bcopyWords(source, desti, nbytes);
}
void bcopyWords
    (
    const void * source,       /* pointer to source buffer      */
...
* SEE ALSO: bcopy()
*/
void bcopyLongs1(UINT32 * source, UINT32* desti, size_t nbytes)
{
	bcopyLongs(source, desti, nbytes);
}
void bcopyLongs
    (
    const void * source,       /* pointer to source buffer      */
...
* SEE ALSO: bcopy()
*/
/*void bcopyQuadsn(UINT64 * source, UINT64 * desti, size_t nquads)
{
	bcopyQuads(source, desti, nquads);
}
*/
void bcopyQuads
    (
	...
	size_t offset = (size_t)((UINT64 *)destination - (UINT64 *)source);
...
* SEE ALSO: bfillBytes()
*/
void bfill1(char * buf, size_t nbytes,int ch)
{
	bfill(buf, nbytes, ch);
}
void bfill
...
* SEE ALSO: bfill()
*/
void bfillBytes1(char * buf, size_t nbytes, int ch)
{
	bfillBytes(buf, nbytes, ch);
}
void bfillBytes
    (
    void * buf,        /* pointer to buffer              */
