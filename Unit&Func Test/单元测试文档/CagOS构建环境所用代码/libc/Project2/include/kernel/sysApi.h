...
INT32 os_del_task(INT32 prio, UINT32 *err);
INT32 os_resume_task(INT32 prio, UINT32 *err);
INT32 os_suspend_task(INT32 prio, UINT32 *err);
void os_delay_task(INT32 ticks, UINT32 *err);
void udelay(INT32 us);

UINT32 os_task_sem_pend(INT32 timeout, UINT16 opt,UINT32 *err);
UINT32 os_task_sem_post(INT32 prio, UINT16 opt, UINT32 *err);
UINT32 os_task_sem_set(INT32 prio,UINT32 cnt, UINT32 *err);
...
INT32 os_queue_get(INT32 qnum,char *buf,INT32 *size,INT32 opt,INT32 timeout, UINT32 *err);
