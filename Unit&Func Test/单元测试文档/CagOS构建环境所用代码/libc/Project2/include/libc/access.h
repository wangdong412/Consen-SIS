...
extern "C" {
	...
	__inline UINT32  readl(void* addr)
	{ 
		return *(volatile UINT32 *)(addr); 
	}
	__inline UINT16 readw(void* addr) { return *(volatile UINT16 *)(addr); }
	__inline UINT8 readb(void* addr){ return *(volatile UINT8 *)(addr); }
	__inline void writel(void* addr, UINT32 val) { *(volatile UINT32 *)(addr) = val; }
	__inline void writew(void* addr, UINT16 val) { *(volatile UINT16 *)(addr) = val; }
	__inline void writeb(void* addr, UINT8 val) { *(volatile UINT8 *)(addr) = val; }
